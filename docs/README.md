...
*Comprehensive documentation for the Cawnex autonomous AI platform*
...
*Keep documentation current, concise, and actionable. Update this README when adding new documentation categories.*